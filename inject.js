...
(function() {
    ...
    function setConversationFocus(list, index) {
        return list.querySelectorAll('li a')[index].click();
    }

    function bindShortcutKey(index) {
        var num = index + 1;
        Mousetrap.bindGlobal('command+' + num, function(e) {
            setConversationFocus(listConversation, index);
            return false;
        });
    }
    ...
    function hasActiveInput() {
        ...
        return ae.getAttribute('type') == 'text' ||
    ...
    function keydownHandler(e){
        ...
        if ((65 <= keycode && keycode <=90) ||
            ...
            console.log('auto focus chat textbox');
